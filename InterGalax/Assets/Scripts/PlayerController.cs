...
public class PlayerController : MonoBehaviour
{
    ...
    void Jump()
    {
        ...
        if (!col.IsTouchingLayers(LayerMask.GetMask("Terrain", "Platform","Traps"))) // Si el jugador no está tocando el terreno, las plataformas o las trampas, no puede saltar
